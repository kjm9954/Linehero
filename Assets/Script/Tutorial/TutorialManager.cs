...
public class TutorialManager : MonoBehaviour
{
    ...
    protected void SpawnTuto()
    {
        rightenemy = (GameObject)Instantiate(tutomon, new Vector3(height_x, height_y, -1f), Quaternion.identity);
        rightenemy.tag = "UpEnemy";
        Rigidbody2D rb = rightenemy.GetComponent<Rigidbody2D>();
    }
